...
public class JwtAuthenticationRestController {
  ...
  public void saveEncryptedPassword(@RequestBody JwtUserDetails jwtUserDetails) {
	  ...
	  UserDetail userDetails = new UserDetail(jwtUserDetails.getUsername(), jwtUserDetails.getFirstName(), jwtUserDetails.getLastName(), jwtUserDetails.getPhone(), jwtUserDetails.getEmail());
  ...
  @GetMapping(path="userdetails/{username}")
	public UserDetail getUserDetails(@PathVariable String username) {
